...
# Upgrade The Odissei portal, from 6.6 to 6.9
# https://github.com/IQSS/dataverse/releases/tag/v6.9

echo "--- Upgrading Dataverse from 6.6 to 6.9 ---"

UPGRADE_DIR="utils/upgrades/6.6to6.9"
...
SQL_DUMP_FILENAME="upgrade-from6.6-dump.sql"
DOT_ENV_FILENAME="dot_env_6.9"
...
echo ""
echo "Upgrade from 6.6 to 6.9 completed successfully!"
